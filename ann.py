...
class Perceptron:
    def __init__(self,w1,w2,bias,a,theta=-1):
    ...
    def fit(self,x1,x2,t):
        ...
        while 0 in flag:
            for i in range(len(x1)):
                ...
                y = self.activation_function(yin,"binary")
                if(y == t[i]):
                    flag[i] = 1
                else:
    ...
    def predict(self,input1,input2):
        ...
        return self.activation_function((input1*self.w1 + input2*self.w2)+self.bias, activation="binary")
